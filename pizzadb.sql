...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2023 at 05:51 PM
...
INSERT INTO `customerorder` (`CustomerOrderId`, `OrderRef`, `TotalPrice`, `Address`, `PhoneNumber`, `CustomerID`) VALUES
(5, 'NDAEVSgo', 0, '', '', NULL);
...
--
ALTER TABLE `customerorder`
  MODIFY `CustomerOrderId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `customerorderitem`
--
ALTER TABLE `customerorderitem`
  MODIFY `CustomerOrderItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `customerorder`
  ADD CONSTRAINT `customerorder_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`ID`);
